...
class rent : public customer // inhereted class from customer class
{
    ...
    do
    {
        ...
        cout<<"\t\t\t\tEnter 'A' for Audi A8 ."<<endl;
        cout<<"\t\t\t\tEnter 'B' for BMW ."<<endl;
 ...
 if(carmodel=="A")
 {
 	system("CLS");
		...
		cout<<"You selected Audi A8. "<<endl;
...
while(carmodel !="A" && carmodel !="B" &&  carmodel !="C" );
    ...
    cout<<"Please Enter the Number of Cars for rent. : ";
    cin >> carnumber;
	...
	int calculate()
	{
        ...
        rentalfee=carnumber*days*5000;
        if(carmodel == "B" ||carmodel=="b")
        rentalfee=carnumber*days*7000;
        if(carmodel == "C" ||carmodel=="c")
        rentalfee=carnumber*days*9000;
    }
void showrent()
    {
